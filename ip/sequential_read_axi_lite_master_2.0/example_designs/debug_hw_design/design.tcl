...
proc create_ipi_design { offsetfile design_name } {
	...
	set sequential_read_axi_lite_master_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:sequential_read_axi_lite_master:2.0 sequential_read_axi_lite_master_0 ]
	...
	# Copy all address to sequential_read_axi_lite_master_v2_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/sequential_read_axi_lite_master_v2_0_include.tcl"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:sequential_read_axi_lite_master:2.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/sequential_read_axi_lite_master_v2_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "sequential_read_axi_lite_master_v2_0_hw_${i}"
