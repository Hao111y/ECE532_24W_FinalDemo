...
HD_PWD='C:/Users/Jazim/school/ECE532/project/Vivado/custom_ip/ip_repo/ddr_to_bram/edit_ddr_to_bram_vga_stream_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ddr_to_bram_vga_stream_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ddr_to_bram_vga_stream_v1_0.tcl
