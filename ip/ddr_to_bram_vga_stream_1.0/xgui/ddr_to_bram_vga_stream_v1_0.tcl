...
proc update_PARAM_VALUE.FRAME_BUFFER_COUNT { PARAM_VALUE.FRAME_BUFFER_COUNT } {
	# Procedure called to update FRAME_BUFFER_COUNT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.FRAME_BUFFER_COUNT { PARAM_VALUE.FRAME_BUFFER_COUNT } {
	# Procedure called to validate FRAME_BUFFER_COUNT
	return true
}

proc update_PARAM_VALUE.LINE_COUNT { PARAM_VALUE.LINE_COUNT } {
	# Procedure called to update LINE_COUNT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.LINE_COUNT { PARAM_VALUE.LINE_COUNT } {
	# Procedure called to validate LINE_COUNT
	return true
}

proc update_PARAM_VALUE.PIXEL_HEIGHT { PARAM_VALUE.PIXEL_HEIGHT } {
	# Procedure called to update PIXEL_HEIGHT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.PIXEL_HEIGHT { PARAM_VALUE.PIXEL_HEIGHT } {
	# Procedure called to validate PIXEL_HEIGHT
	return true
}
...
proc update_MODELPARAM_VALUE.FRAME_BUFFER_COUNT { MODELPARAM_VALUE.FRAME_BUFFER_COUNT PARAM_VALUE.FRAME_BUFFER_COUNT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.FRAME_BUFFER_COUNT}] ${MODELPARAM_VALUE.FRAME_BUFFER_COUNT}
}

proc update_MODELPARAM_VALUE.LINE_COUNT { MODELPARAM_VALUE.LINE_COUNT PARAM_VALUE.LINE_COUNT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.LINE_COUNT}] ${MODELPARAM_VALUE.LINE_COUNT}
}
...
proc update_MODELPARAM_VALUE.PIXEL_HEIGHT { MODELPARAM_VALUE.PIXEL_HEIGHT PARAM_VALUE.PIXEL_HEIGHT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.PIXEL_HEIGHT}] ${MODELPARAM_VALUE.PIXEL_HEIGHT}
}
