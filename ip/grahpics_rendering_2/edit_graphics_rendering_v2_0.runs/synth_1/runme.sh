...
HD_PWD='c:/users/jazim/school/ece532/project/vivado/custom_ip/ip_repo/grahpics_rendering_2/edit_graphics_rendering_v2_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log graphics_rendering_v2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source graphics_rendering_v2_0.tcl
