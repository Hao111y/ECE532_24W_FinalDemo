...
HD_PWD='c:/users/jazim/school/ece532/project/vivado/custom_ip/ip_repo/edit_physics_core_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log physics_core_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source physics_core_v1_0.tcl
