...
// Instantiation of Axi Bus Interface M00_AXI
	bram_2_ddr_stream_v1_0_M00_AXI # ( 
		...
		.PIXEL_HEIGHT(PIXEL_COUNT)
	) bram_2_ddr_stream_v1_0_M00_AXI_inst (
	    .BRAM_ADDR(BRAM_ADDR),
		.bram_data(bram_data),
		.BRAM_EN(BRAM_EN),
		
		 // Debuig Wires
        .burst_count_total(burst_count_total),
        .start_single_burst(start_single_burst),
